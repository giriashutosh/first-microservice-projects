package com.ashutosh.gateway.apigateway.controllers;

import com.ashutosh.gateway.apigateway.models.AuthResponse;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> login(@RegisteredOAuth2AuthorizedClient("okta")OAuth2AuthorizedClient client,
        ...
        authResponse.setRefeshToken(client.getRefreshToken().getTokenValue());
